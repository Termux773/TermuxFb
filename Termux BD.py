...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|          Termux909       Channel                |
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;91m [⚡\033[1;97mAuthor Name: Termux909        ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Channel: Termux 909  ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mwhatsApp: +8801919012108 ⚡\033[1;91m]
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠿⡾⠿⠛⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠂⠀⠀⠀⠀⠀⠈⠛⠃⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡀⢀⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mTermux909\033[1;95m-_-_-_-_-_-_-_-_-»
\033[1;92mNote1: Enter Tool usernam and Password 
\033[1;92mNote2: This Tool is only for Bangladesh
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mTermux909\033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "Khairiah"
CorrectPassword = "Khairiah1"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('https://youtube.com/@Termux909')
    else:
        print "\033[1;94mWrong Username"
        os.system('https://www.facebook.com/profile.php?id=100089160275499&mibextid=ZbWKwL')
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://youtube.com/@Termux909')
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe Termux909 Youtube Channel " 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mTermux909\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
